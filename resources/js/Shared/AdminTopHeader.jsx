...
export default () => {
     ...
     return (
          <div className="flex items-center justify-between px-6 py-2 bg-slate-200 md:flex-shrink-0 md:w-24 md:justify-center">
               ...
               <div className="relative md:hidden">
                    ...
                    <div className={`${menuOpened ? '' : 'hidden'} absolute right-0 z-20`}>
                         <MainMenuAdmin className="relative z-20 px-8 py-4 pb-2 mt-2 bg-indigo-800 rounded shadow-lg" />
