...
export default () => {
     ...
     return (
          <div className="bg-slate-200 md:flex-shrink-0 md:w-24 px-6 py-2 flex items-center justify-between md:justify-center">
               ...
               <div className="relative md:hidden">
                    ...
                    <div className={`${menuOpened ? '' : 'hidden'} absolute right-0 z-20`}>
                         <MainMenuAdmin className="relative z-20 mt-2 px-8 py-4 pb-2 shadow-lg bg-indigo-800 rounded" />
