...
export function ButtonLinkSimple ({caption, icon, link, linkParams, ...props}) {
     return (<Link href={linkParams?route(link, linkParams):route(link)} className="inline-flex items-center px-1 py-1 mr-2 text-sm rounded bg-slate-200 hover:bg-slate-300 text-slate-700">
