...
export function ButtonLinkSimple ({caption, icon, link, linkParams, ...props}) {
     return (<InertiaLink href={linkParams?route(link, linkParams):route(link)} className="bg-slate-200 hover:bg-slate-300 mr-2 text-slate-700 text-sm py-1 px-1 rounded inline-flex items-center">
