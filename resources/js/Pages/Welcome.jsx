          ...
          <React.Fragment key="welcom">
               ...
               <div className="flex items-center justify-center min-h-screen p-6">
                    <div className="w-full max-w-xl p-4 text-lg leading-loose text-center text-gray-500 bg-white rounded shadow-xl">
                         Welcome to the <h1 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-purple-500">Laravel 10 | Fortify | TailwindCSS 3 | InertiaJs | Reactjs</h1>
