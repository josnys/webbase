          ...
          <React.Fragment key="app">
               ...
               <div className="p-6 min-h-screen flex justify-center items-center">
                    <div className="bg-white p-4 rounded text-center text-lg text-gray-500 shadow-xl w-full max-w-xl leading-loose">
                         Welcome to the <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-300 to-purple-500">Laravel 8 | Fortify | TailwindCSS | InertiaJs | Reactjs</h1>
